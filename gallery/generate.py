...
def verify_function() -> bytes:
    ...
    lines.append(
        "tellraw @a {\"text\":\"Extreme Reactors placeholder gallery checked\","
        "\"color\":\"yellow\"}"
    )
    return text_bytes("\n".join(lines))
...
def base_files() -> dict[Path, bytes]:
    ...
    return {
        ...
        Path("datapack/pack.mcmeta"): json_bytes(
            {
                "pack": {
                    "description": "ATM 1.2.0 Extreme Reactors placeholder gallery",
                    "pack_format": 48,
                }
            }
        ),
        ...
        function_root / "load.mcfunction": text_bytes(
            "# Generated by gallery/generate.py; do not edit.\n"
            "tellraw @a {\"text\":\"Extreme Reactors placeholder gallery loaded; "
