...
package io.github.janguenter.bluemap.bigreactors;

import io.github.janguenter.bluemap.bigreactors.adapter.bluemap522.AdapterCompatibility;

import java.lang.reflect.InvocationTargetException;
import java.lang.reflect.Method;

/** BlueMap add-on entrypoint installed before resource-pack construction. */
public final class BlueMapBigReactorsAddon implements Runnable {
    ...
    public void run() {
        try {
            ...
            Class<?> adapter = Class.forName(
                    "io.github.janguenter.bluemap.bigreactors.adapter.bluemap522.BlueMap522Adapter",
                    true,
                    BlueMapBigReactorsAddon.class.getClassLoader()
            );
    ...
    private static void inactive(String reason, Throwable cause) {
        ...
        System.err.println("BlueMap Extreme Reactors add-on is inactive: "
                + reason + detail + '.');
    }
}
