...
| BlueMap Add-on Adapter API | `0.1.0-alpha.2` / `e81f08bc4bfbf02d810ec8949a019130e2e61634` / source tree `2f974c9bb2ba13888d69682f86f30f58922d30eb` | MIT | Four exact gitlink-pinned sources compiled into this add-on | Source only |
| Extreme Reactors profile | `bigreactors-1.21.1-2.4.28` | See `provenance/upstreams.json` | Exact installed-artifact and resource evidence only | No |
